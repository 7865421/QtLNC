...
public:
    ...
    IMEXPORT int  CALBY FtpUploadFile (int Folder, char *SubFolder, char *Filename, char *LocalFilename);   //上傳檔案
    IMEXPORT int  CALBY FtpDownloadFile (int Folder, char *SubFolder, char *Filename, char *LocalFilename); //下載檔案
    IMEXPORT int  CALBY FtpDeleteFile (int Folder, char *SubFolder, char *Filename);                        //刪除檔案
